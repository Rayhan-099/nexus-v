...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      ...
      >
        <h2 className="text-2xl font-orbitron font-bold text-center text-primary mb-6">LOGIN</h2>
        ...
        <p className="text-center text-sm text-slate-400 mt-4">
          New user? <Link to="/register" className="text-primary font-bold">Register Here</Link>
        </p>
      </motion.div>
    </div>
  );
